...
int32	colon2mac(char *, byte *)                                   SECT("XCOL2MAC");
int32	allocRxBuffer(struct ether *, int32)                        SECT("XALRXBUF");
int32	waitOnBit(volatile uint32 *, uint32, const int32, int32)    SECT("XWONBIT");
